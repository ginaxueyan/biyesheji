<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiangsi.aspx.cs" Inherits="Front_xiangsi" %>
...
<body>
    ...
    <h3 style="background-color: #FF3399; font-size: 17px; font-weight: bold; color: #FFFFFF; width: 80px; height: 30px;text-align:center;line-height:30px">相思雪</h3><br />
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1" 
                                ...
                                Text='<%# Eval("花名") %>' Font-Bold="True" Font-Italic="False" Font-Overline="False"></asp:LinkButton>
                                            <br />
