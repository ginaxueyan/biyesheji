<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qingqing.aspx.cs" Inherits="Front_qingqing" %>
...
<body>
    ...
    <h3 style="background-color: #FF3399; font-size: 17px; font-weight: bold; color: #FFFFFF; width: 80px; height: 30px;text-align:center;line-height:30px">青青子衿</h3><br />
