<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tianshi.aspx.cs" Inherits="Front_tianshi" %>
...
<body>
    ...
    <h3 style="background-color: #FF3399; font-size: 17px; font-weight: bold; color: #FFFFFF; width: 80px; height: 30px;text-align:center;line-height:30px">天使之祈</h3><br />
